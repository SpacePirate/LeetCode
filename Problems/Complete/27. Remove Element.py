...
class Solution(object):
    def removeElement(self, nums: List[int], val: int) -> int:
        """
        Runtime: 33 ms, faster than 24.16% of Python online submissions for Remove Element.
        Memory Usage: 13.4 MB, less than 38.71% of Python online submissions for Remove Element.
        """
        k = 0
...
def test_case(*args, **kwargs):
    ans = Solution().removeElement(*args, **kwargs)
